...
<div class="dashboard-layout">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/browse"><span class="icon">🔍</span> Browse Houses</a></li>
            <li><a href="/favourites"><span class="icon">❤️</span> Favourites</a></li>
            <li><a href="/bookings"><span class="icon">📅</span> My Bookings</a></li>
            <li><a href="/messages"><span class="icon">💬</span> Messages</a></li>
    ...
    <main class="dashboard-content">
        ...
        <div style="background:white; border-radius:10px; padding:28px; box-shadow: var(--shadow);">
            ...
            <div style="display:flex; gap:16px; flex-wrap:wrap;">
                <a href="/browse" class="btn btn-primary">🔍 Browse Houses</a>
                <a href="/browse?type=bedsitter" class="btn btn-outline">🛏 Find Bedsitter</a>
                <a href="/browse?type=1_bedroom" class="btn btn-outline">🏠 1 Bedroom</a>
                <a href="/browse?type=2_bedroom" class="btn btn-outline">🏡 2 Bedrooms</a>
            </div>
        </div>
