...
<div class="dashboard-layout">
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('landlord.profile') }}" class="active"><span class="icon">👤</span> Profile</a></li>
        </ul>
    ...
    <main class="dashboard-content">
        <div style="margin-bottom:24px;">
            <h1 style="font-size:24px; font-weight:700;">👤 My Profile</h1>
            ...
            <div>
                <div style="background:white; border-radius:12px; padding:28px; box-shadow:var(--shadow); text-align:center;">
                    ...
                    @if(Auth::guard('landlord')->user()->is_verified)
                        <span style="display:inline-block; background:#d1fae5; color:#065f46; padding:4px 14px; border-radius:20px; font-size:12px; font-weight:600; margin-top:10px;">✓ Verified Landlord</span>
                    @else
                        <span style="display:inline-block; background:#fef3c7; color:#92400e; padding:4px 14px; border-radius:20px; font-size:12px; font-weight:600; margin-top:10px;">⏳ Pending Verification</span>
                    @endif
