...
<div class="dashboard-layout">
    ...
    <main class="dashboard-content">
        <div style="margin-bottom:24px;">
            <h1 style="font-size:24px; font-weight:700;"><i class="fa-solid fa-pen-to-square" style="color: #1E7A5A; margin-right:6px;"></i> Edit Property</h1>
        ...
        <form method="POST" action="{{ route('landlord.properties.update', $property) }}" enctype="multipart/form-data">
            ...
            <div style="background:white; border-radius:10px; padding:28px; box-shadow:var(--shadow); margin-bottom:24px;">
                ...
                <div style="background:#f0faf5; border-radius:8px; padding:12px 16px; margin-bottom:16px; font-size:13px; color:var(--primary);" id="pinStatus">
                    <i class="fa-solid fa-map-pin" style="color: rgba(230, 57, 70, 1);"></i> Click on the map above to update the property location
                </div>
            ...
            {{-- COVER IMAGE --}}
            <div style="background:white; border-radius:10px; padding:28px; box-shadow:var(--shadow); margin-bottom:24px;">
                <div class="section-title"><i class="fa-solid fa-camera"></i> Cover Image</div>
            ...
            <div style="display:flex; gap:16px;">
                <button type="submit" class="btn btn-primary" style="padding:14px 36px;"><i class="fa-solid fa-upload" style="color: rgba(245, 158, 11, 1);"></i> Save Changes</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hasCoords) {
        const icon = L.divIcon({
            html: '<div style="background:#1E7A5A; color:white; padding:6px 10px; border-radius:8px; font-size:12px; font-weight:600; box-shadow:0 2px 8px rgba(0,0,0,0.3); white-space:nowrap;"><i class="fa-solid fa-location-pin" style="color: rgb(230, 57, 70);"></i> Current Location</div>',
            className: '',
            iconAnchor: [0, 0]
        });
